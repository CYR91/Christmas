...
const modalMessageList = [
  { "number": 1, "message": "행복의 계절, 이령이와 함께하는 25일!" },
  { "number": 2, "message": "이 12월, 행복한 순간이 우리를 감싸네요." },
  { "number": 3, "message": "이령이와 같이 즐겁게 보내는 25일, 행복이 가득합니다!" },
  { "number": 4, "message": "12월의 특별함을 이령이와 함께 나누어요." },
  { "number": 5, "message": "우리의 작은 행복이 모여 만드는 특별한 25일!" },
  { "number": 6, "message": "행복이라는 이름의 캘린더, 모두에게 열려 있어요." },
  { "number": 7, "message": "이령이와 함께 하는 즐거움, 25일 동안 계속되길 바랍니다." },
  { "number": 8, "message": "12월은 행복한 순간들이 가득한 달이에요." },
  { "number": 9, "message": "우리 모두에게 찾아온 특별한 행복의 계절!" },
  { "number": 10, "message": "매일 매일이 행복으로 가득찬 25일이 되길." },
  { "number": 11, "message": "12월, 행복이 가득한 이령이와 나누는 소중한 시간." },
  { "number": 12, "message": "이령이와 함께하는 25일, 행복이 여러 가지 모습으로 찾아올 거예요." },
